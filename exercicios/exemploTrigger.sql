...
-- assim que os dados são inseridos na tabela, os triggers acionarão a exibição destes dados 
...
SELECT I.NOME FROM inserted i where i.Nome in (select Nome from Pet);
